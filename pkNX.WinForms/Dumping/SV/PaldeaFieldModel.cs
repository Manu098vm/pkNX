...
public class PaldeaFieldModel
{
    ...
    public PaldeaFieldModel(IFileInternal ROM)
    {
        ...
        MainAreas[(int)PaldeaFieldIndex.Blueberry] = FlatBufferConverter.DeserializeFrom<FieldMainAreaArray>(ROM.GetPackedFile("world/data/field/area_su2/field_main_area_su2/field_main_area_su2_array.bin")).Table;
        SubAreas[(int)PaldeaFieldIndex.Blueberry] = FlatBufferConverter.DeserializeFrom<FieldSubAreaArray>(ROM.GetPackedFile("world/data/field/area_su2/field_sub_area_su2/field_sub_area_su2_array.bin")).Table;
        InsideAreas[(int)PaldeaFieldIndex.Blueberry] = FlatBufferConverter.DeserializeFrom<FieldInsideAreaArray>(ROM.GetPackedFile("world/data/field/area_su2/field_inside_area_su2/field_inside_area_su2_array.bin")).Table;
        DungeonAreas[(int)PaldeaFieldIndex.Blueberry] = FlatBufferConverter.DeserializeFrom<FieldDungeonAreaArray>(ROM.GetPackedFile("world/data/field/area_su2/field_dungeon_area_su2/field_dungeon_area_su2_array.bin")).Table;
        //FieldLocations[(int)PaldeaFieldIndex.Blueberry] = FlatBufferConverter.DeserializeFrom<FieldLocationArray>(ROM.GetPackedFile("world/data/field/area_su2/field_location_su2/field_location_su2_array.bin")).Table;
    }
